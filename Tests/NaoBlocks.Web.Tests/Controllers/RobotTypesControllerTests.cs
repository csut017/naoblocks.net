    ...
    public class RobotTypesControllerTests
    {
        ...
        public async Task ImportDefinitionCallsCommand()
        {
            ...
            engine.ExpectCommand<ParseRobotTypeImport>(
                CommandResult.New(1, new Data.RobotTypeImport { Item = new Data.RobotType() }));
            var controller = InitialiseController(engine);
        ...
        public async Task ImportIncludesParseDetails()
        {
            ...
            var engine = new FakeEngine();
            engine.ExpectCommand<ParseRobotTypeImport>(
                CommandResult.New(1, new Data.RobotTypeImport { Item = new Data.RobotType(), Message = "Parsed" }));
            var controller = InitialiseController(engine);
            controller.SetRequestFiles("first");
