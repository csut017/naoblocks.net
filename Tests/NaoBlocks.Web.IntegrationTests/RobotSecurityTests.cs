...
{
    public class RobotSecurityTests
        : SecurityTestsBase
    {
        public RobotSecurityTests()
        {
            // Allowed robot requests
            AddUrlsToCheck(
                UserRole.Robot,
                HttpStatusCode.OK,
            ...
            // Allowed robot requests that fail due to a lack of data (should add proper tests at some point)
            AddUrlsToCheck(
                UserRole.Robot,
