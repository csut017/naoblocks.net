...
{
    public class AdministratorSecurityTests
        : SecurityTestsBase
    {
        public AdministratorSecurityTests()
        {
            // Allowed administrator requests
            AddUrlsToCheck(
            ...
            // Allowed administrator requests that fail due to a lack of data (should add proper tests at some point)
            AddUrlsToCheck(
                UserRole.Administrator,
