  ...
  processServerMessage(msg: ClientMessage) {
    ...
    switch (msg.type) {
      ...
      case ClientMessageType.RobotAllocated:
        ...
        this.currentStartStep = this.updater.onStepCompleted(this.currentStartStep || 0);
      ...
      case ClientMessageType.NoRobotsAvailable:
        ...
        this.updater.onStepFailed(this.currentStartStep || 0, 'No robots available');
        this.currentStartStep = undefined;
        this.updater.onCloseConnection();
        break;
      ...
      case ClientMessageType.UnableToDownloadProgram:
        ...
        this.updater.onStepFailed(this.currentStartStep || 0, 'Program download failed');
        this.currentStartStep = undefined;
        this.updater.onCloseConnection();
        break;
